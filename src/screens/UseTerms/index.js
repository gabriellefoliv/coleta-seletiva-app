  ...
  return (
    <View style={LocalStyles.container}>
      <View style={LocalStyles.main}>
        <Text style={LocalStyles.title}>Termos de Uso</Text>
      </View>
      <View style={LocalStyles.intro}>
        <Text style={LocalStyles.introText}>
          Bem-vindo aos nossos termos de uso. Por favor, leia atentamente as
          informações a seguir antes de utilizar nosso serviço.
        </Text>
      </View>
